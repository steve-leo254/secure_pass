  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden animate-fade-in">
        {/* Cover */}
        <div className="h-36 bg-linear-to-r from-emerald-600 via-green-600 to-emerald-700 relative">
        ...
        <div className="px-6 pb-6 relative">
          ...
          <div className="absolute -top-14 left-6">
            <div className="relative group">
              <div className="w-28 h-28 rounded-2xl border-4 border-white shadow-xl overflow-hidden bg-linear-to-br from-emerald-500 to-green-600">
                {user?.avatar ? (
                  <img
                    src={user.avatar}
                    alt={user.name}
              ...
              <button
                ...
                className="absolute bottom-1 right-1 w-8 h-8 rounded-lg bg-white shadow-lg border border-slate-200 flex items-center justify-center text-slate-500 hover:text-emerald-600 hover:border-emerald-300 transition-all opacity-0 group-hover:opacity-100"
              >
          ...
          <div className="flex justify-end pt-3 gap-2">
            {isEditing ? (
              <>
                ...
                <button
                  onClick={saveProfile}
                  className="px-4 py-2 bg-linear-to-r from-emerald-600 to-green-600 text-white rounded-xl text-sm font-semibold hover:shadow-lg hover:shadow-emerald-500/25 transition-all flex items-center gap-1.5"
                >
              ...
              <>
                <button
                  onClick={() => setShowAvatarModal(true)}
                  className="px-4 py-2 bg-slate-100 text-slate-800 rounded-xl text-sm font-semibold hover:bg-slate-200 transition-all flex items-center gap-1.5"
                >
          ...
          <div className="mt-6">
            {isEditing ? (
              <input
                ...
                className="text-2xl font-black text-slate-800 bg-slate-50 border border-slate-200 rounded-xl px-3 py-1.5 w-full max-w-md focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-400"
              />
            ) : (
            ...
            <div className="flex flex-wrap items-center gap-3 mt-2">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-emerald-50 text-emerald-700 rounded-lg text-xs font-semibold border border-emerald-100 capitalize">
            ...
            {isEditing ? (
              <textarea
                ...
                className="mt-3 w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-600 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-400 resize-none"
                rows={2}
              />
            ) : (
              user?.bio && (
              ...
              <div className="flex-1 min-w-0">
                ...
                {isEditing ? (
                  <input
                    ...
                    value={editName}
                    onChange={(e) => setEditName(e.target.value)}
                    className="w-full px-3 py-1.5 bg-slate-50 border border-slate-200 rounded-lg text-sm mt-1 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-400"
                  />
                ) : (
