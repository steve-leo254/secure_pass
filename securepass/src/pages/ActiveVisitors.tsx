            ...
            >
              ...
              <div className="px-5 pb-5">
                <button
                  ...
                  className="w-full py-2.5 bg-gradient-to-r from-red-500 to-rose-600 text-white font-semibold text-sm rounded-xl hover:shadow-lg hover:shadow-red-500/25 active:scale-[0.98] transition-all flex items-center justify-center gap-2"
                >
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg animate-scale-in">
            ...
            <div className="p-6 border-t border-slate-100 flex gap-3">
              ...
              <button
                ...
                className="flex-1 py-3 bg-gradient-to-r from-red-500 to-rose-600 text-white font-bold text-sm rounded-xl hover:shadow-lg hover:shadow-red-500/25 active:scale-[0.98] transition-all disabled:opacity-40 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
